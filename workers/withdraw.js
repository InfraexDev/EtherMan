...
function withdraw(params) {
    ...
    var daiContract = new web3.eth.contract(daiABI).at(process.env.DAI_ContractAddress);

    amount = '0x' + parseInt(web3.toWei(amount.toString(),"ether")).toString(16);
    var data = abi_encode('transfer(address,uint256)',[toAddress,amount]);

    if(web3.personal.unlockAccount(web3.eth.coinbase, process.env.DAI_PASSPHARSE, 30)){
        // daiContract.transfer.estimateGas()
        var gasAmount = web3.eth.estimateGas({
